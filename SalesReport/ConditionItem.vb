...
Partial Public Class ConditionItem
    ...
    Private Sub seValue1_EditValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles seValue1.EditValueChanged
        If init OrElse item Is Nothing Then
            Return
        End If
        item.Value1 = seValue1.EditValue
        RaiseRefreshValues()
    End Sub
    ...
    Private Sub seValue2_EditValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles seValue2.EditValueChanged
        If init OrElse item Is Nothing Then
            Return
        End If
        item.Value2 = seValue2.EditValue
        RaiseRefreshValues()
    End Sub
    ...
    '  Private Sub propertyGrid1_CellValueChanged(ByVal sender As System.Object, ByVal e As DevExpress.XtraVerticalGrid.Events.CellValueChangedEventArgs) Handles propertyGrid1.CellValueChanged
    '
    '   If e.Row.Name = "rowBackColor" Then
    '   item.Appearance.BackColor2 = e.Value
    'End If
    'End Sub
End Class
