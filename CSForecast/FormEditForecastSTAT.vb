...
Public Class FormEditForecastSTAT
            ...
            Try
                ...
                If codigo <> String.Empty Then
                    ...
                    Dim ForecastConsulta = From p In db.SapForecastStat
                                           Where p.CodCliStat = codigo And p.Year = ano And p.Period = periodo Select p

                    DirectCast(ForecastConsulta, ObjectQuery(Of SapForecastStat)).MergeOption = MergeOption.OverwriteChanges
    ...
    Private Sub bandedGridView1_CustomUnboundColumnData(sender As System.Object, e As DevExpress.XtraGrid.Views.Base.CustomColumnDataEventArgs) Handles BandedGridView1.CustomUnboundColumnData
        ...
        ElseIf e.Column.FieldName = "colStatusPricing" And e.IsGetData Then
            Dim PARCodCliEst = DirectCast(e.Row, CSForecast.SapForecastStat).CodCliStat
            Dim PARCodCliFact = DirectCast(e.Row, CSForecast.SapForecastStat).CodCliFact
            Dim PARCodigo = DirectCast(e.Row, CSForecast.SapForecastStat).Codigo
            Dim PARTPRE = DirectCast(e.Row, CSForecast.SapForecastStat).TPRE
            Dim PARCurrency = DirectCast(e.Row, CSForecast.SapForecastStat).Currency

            If PARCodCliFact = "" Or PARCodCliEst = "" Or PARCodigo = "" Or PARTPRE = "" Or PARCurrency = "" Then Exit Sub
            ...
            Else
                Try
                    Dim statusPricing = From p In db.SapPricingAnalisysforForecast
                                        Where p.INV_CUSTOMER = PARCodCliFact _
                                        And p.STATS_CUSTOMER = PARCodCliEst _
                                        And p.O_REF_CODE = PARCodigo _
                                        And p.PRICE_LIST_TYPE = PARTPRE _
                                        And p.CURRENCY = PARCurrency
                                        Select p.NNSP_CURR_EUR_9L
    ...
    Private Sub bandedGridView1_ValidatingEditor(sender As System.Object, e As DevExpress.XtraEditors.Controls.BaseContainerValidateEditorEventArgs) Handles BandedGridView1.ValidatingEditor
        ...
        If BandedGridView1.FocusedColumn.FieldName = "CodCliStat" Or BandedGridView1.FocusedColumn.FieldName = "CodCliFact" Then
