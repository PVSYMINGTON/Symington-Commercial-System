...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.PictureBox3.BackgroundImage = Global.PricingSAP.My.Resources.Resources.PricingCommercialsystembarra
        ...
        Me.PictureBox1.Location = New System.Drawing.Point(296, 474)
...
#End Region
    ...
    Private Sub FormTreesPricing_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ' strsql = "SELECT   ERCLIEF.CLNCLI AS Cliente FROM ((ERCLIEF LEFT OUTER JOIN PCDIREF ON ERCLIEF.CLDRES = PCDIREF.DICODI) LEFT OUTER JOIN PCPAISF ON ERCLIEF.CLPAIS = PCPAISF.PACODI) where (" & Forcefilterkeydir & ") GROUP BY PCDIREF.DIDESC, PCPAISF.PADESC, ERCLIEF.CLNCLI "
