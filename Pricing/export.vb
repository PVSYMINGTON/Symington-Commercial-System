Public Class export
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim filenamestr As String = UserIdentityInfo.Name.ToString.Remove(0, 10) & Format(Now, "ddMMhhmmss") & ".PPP"
        ...
        myConnection.Open()
        myCommand = New OleDb.OleDbCommand("DELETE FROM paprixf2", myConnection)
